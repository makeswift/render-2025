...
export const buttonVariants = cva(
  'group inline-flex items-center justify-center relative overflow-hidden border-2 font-display font-bold uppercase leading-none text-black transition duration-150 px-5 py-3 pb-2.5 text-sm md:px-6 focus:ring-0 focus-visible:ring-2 focus-visible:ring-blue focus-visible:outline-none',
  {
    variants: {
      variant: {
        primary:

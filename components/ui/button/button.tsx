...
export const buttonVariants = cva(
  'group w-auto inline-flex items-center justify-center relative overflow-hidden border-2 font-display font-bold gap-x-3 uppercase leading-none text-black transition duration-150 px-5 py-2.5 text-xs md:px-5 focus:ring-0 focus-visible:ring-2 focus-visible:ring-blue focus-visible:outline-none',
  {
    variants: {
      variant: {
        primary:
        ...
        secondary:
          'bg-transparent stroke-black [&_svg]:transition-colors [&_svg]:hover:stroke-pink text-black border-2 border-black hover:border-pink disabled:text-gray-400 disabled:hover:bg-transparent disabled:hover:border-gray-400 disabled:hover:text-gray-400',
        subtle:
